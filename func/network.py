...
class CellSegNet_basic_edge_gated_X_batchnorm(nn.Module):
    def __init__(self, input_channel=1, n_classes=3, output_func="softmax"):
        super(CellSegNet_basic_edge_gated_X_batchnorm, self).__init__()
...
class CellSegNet_basic_edge_gated_XIII(nn.Module):
    def __init__(self, input_channel=1, n_classes=3, output_func="softmax"):
        super(CellSegNet_basic_edge_gated_XIII, self).__init__()
        ...
        self.conv_out_16_edge = nn.Conv3d(in_channels=64, out_channels=n_classes, kernel_size=1, stride=1)

        self.deconv2_edge = nn.ConvTranspose3d(in_channels=64, out_channels=64, kernel_size=4, stride=2, padding=1)
        self.bnorm3_edge = nn.GroupNorm(1, 64)

        self.conv_out_32_edge = nn.Conv3d(in_channels=64, out_channels=n_classes, kernel_size=1, stride=1)
...
class CellSegNet_basic_edge_gated_XIV(nn.Module):
    def __init__(self, input_channel=1, n_classes=3, output_func="softmax"):
        super(CellSegNet_basic_edge_gated_XIV, self).__init__()
        ...
        self.bnorm4_edge = nn.GroupNorm(1, 32)
        self.conv6_edge = nn.Conv3d(in_channels=32, out_channels=32, kernel_size=3, stride=1, padding=1)
        self.conv7_edge = nn.Conv3d(in_channels=32, out_channels=n_classes, kernel_size=1, stride=1)
