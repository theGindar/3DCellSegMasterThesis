...
from func.run_pipeline_super_vox import segment_super_vox_2_channel, semantic_segment_crop_and_cat_3_channel_output_edge_gated_model, \
...
save_path_graph_set = f'../../../mnt2/graphs_dataset_train_with_augmentations_LRP_retrained_skript_{script_num}_edge_gated_3output'
txt_write_file_path = f'flag_folder/BBB_{script_num}_edge_gated_threeoutput_FINISHED.txt'
...
for img_name in image_names_to_segment:
    ...
    for img_trans in range(num_augmentations):
        ...
        graph = super_vox_to_graph.get_nx_graph_from_ws_with_gt(seg_foreground_super_voxel_by_ws, hand_seg, True)
