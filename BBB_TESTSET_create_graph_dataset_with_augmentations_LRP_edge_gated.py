...
save_path_graph_set = f'../../../mnt/graphs_dataset_train_with_augmentations_LRP_retrained_skript_{script_num}_edge_gated.pkl'
...
# %%
graphs_list = []
for img_name in LRP_data_dict_test.keys():
    print(img_name)
    if img_name == ".DS_Store":
        continue
    print(f"image to segment: {img_name}")

    hf = h5py.File(LRP_data_dict_test[img_name])
