...
from func.loss_func import dice_accuracy, dice_loss_II, dice_loss_II_weights, dice_loss_org_weights, \
    ...
    balanced_cross_entropy, DiceLoss, balanced_cross_entropy_with_weights, cross_entropy_with_weights
...
# hyperparameters
# ----------
save_path = 'output/model_HMS_edge_gated_21.pkl'
need_resume = True
load_path = 'output/model_HMS_edge_gated_21.pkl'
loss_save_path = 'output/loss_HMS_edge_gated_21.csv'
learning_rate = 1e-4
max_epoch = 500
model_save_freq = 20
...
for ith_epoch in range(0, max_epoch):
    for ith_batch, batch in enumerate(dataset_loader):
        ...
        loss_1=dice_loss_org_weights(seg_output_bb, seg_groundtruth_bb, weights_bb)+\
            dice_loss_II_weights(seg_output_f, seg_groundtruth_f, weights_f) + 0.5 * boundary_loss
