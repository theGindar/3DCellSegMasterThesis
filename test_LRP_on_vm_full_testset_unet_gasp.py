...
from func.run_pipeline_super_vox import segment_super_vox_3_channel, semantic_segment_crop_and_cat_3_channel_output, \
    img_3d_erosion_or_expansion, segment_super_vox_2_channel_gasp, semantic_segment_crop_and_cat_2_channel_output, \
...
results_output_path = "output/results_test_model_LRP_unet_gasp.csv"
...
def pipeline(raw_img, hand_seg, model, device,
             ...
             test_file_name=None):
    seg_final = segment_super_vox_2_channel_gasp(raw_img, model, device,
                                             ...
                                             intermediate_results_save_path="../../../mnt2/lrp_results/gasp/")
