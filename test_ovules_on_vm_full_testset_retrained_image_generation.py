...
results_output_path = "output/results_test_model_Ovules_retrained_control_background_2_image_generation.csv"
...
def pipeline(raw_img, hand_seg, model, device,
    ...
    seg_final = segment_super_vox_3_channel(raw_img, model, device,
                                             ...
                                             intermediate_results_save_path="../../../mnt2/ovules_results/retrained/")
