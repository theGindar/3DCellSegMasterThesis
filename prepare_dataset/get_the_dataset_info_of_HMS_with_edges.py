...
for name in names:
    if str(name) in test_names:
        ...
        HMS_data_dict["test"][name]["centroid_foreground"] = os.path.join(HMS_path_seg, name + "/" + name + "_centroid_foreground_3d_mask.npy")
        ...
        HMS_data_dict["train"][name]["centroid_foreground"] = os.path.join(HMS_path_seg, name + "/" + name + "_centroid_foreground_3d_mask.npy")
