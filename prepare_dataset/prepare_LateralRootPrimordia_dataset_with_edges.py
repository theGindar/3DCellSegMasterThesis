...
for category in pic_dict.keys():
    ...
    for case_name in pic_dict[category].keys():
        ...
        raw_img, background_3d_mask, boundary_3d_mask, foreground_3d_mask, background_edge_3d_mask, boundary_edge_3d_mask, foreground_edge_3d_mask, cell_ins_3d_mask, center_dict = \
        ...
        h.create_dataset("edge_foreground", data=foreground_edge_3d_mask)
        h.create_dataset("edge_boundary", data=boundary_edge_3d_mask)
        h.create_dataset("edge_background", data=background_edge_3d_mask)
        h.close()
        """
