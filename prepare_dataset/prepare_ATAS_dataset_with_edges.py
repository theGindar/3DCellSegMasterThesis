...
def process_one(raw_img_path, seg_img_path):
    ...
    background_3d_mask, boundary_3d_mask, foreground_3d_mask, edge_background_3d_mask, edge_boundary_3d_mask, edge_foreground_3d_mask, centroid_foreground_3d_mask, cell_ins_3d_mask, center_dict = process_one_cuboid_with_all_edges(seg_img, width_of_membrane = args.width_of_membrane)
    ...
    return raw_img, background_3d_mask, boundary_3d_mask, foreground_3d_mask, edge_background_3d_mask, edge_boundary_3d_mask, edge_foreground_3d_mask, cell_ins_3d_mask, center_dict
...
for img_name in pic_dict.keys():
    ...
    if len(pic_dict[img_name])==2:
        ...
        raw_img, background_3d_mask, boundary_3d_mask, foreground_3d_mask, edge_background_3d_mask, edge_boundary_3d_mask, edge_foreground_3d_mask, cell_ins_3d_mask, center_dict = \
        ...
        h.create_dataset("edge_background", data=edge_background_3d_mask)
        h.create_dataset("edge_boundary", data=edge_boundary_3d_mask)
        h.create_dataset("edge_foreground", data=edge_foreground_3d_mask)
