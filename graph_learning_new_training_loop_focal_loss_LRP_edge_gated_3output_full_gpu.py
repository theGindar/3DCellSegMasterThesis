...
data_path = "../../../mnt2/"
graph_paths = [
    "graphs_dataset_train_LRP_retrained_SMALL_1_edge_gated_3output.pbz2",
    "graphs_dataset_train_LRP_retrained_SMALL_2_edge_gated_3output.pbz2",
    "graphs_dataset_train_LRP_retrained_SMALL_3_edge_gated_3output.pbz2",
    "graphs_dataset_train_LRP_retrained_SMALL_4_edge_gated_3output.pbz2",
    "graphs_dataset_train_LRP_retrained_SMALL_5_edge_gated_3output.pbz2",
    "graphs_dataset_train_LRP_retrained_SMALL_6_edge_gated_3output.pbz2"
]
