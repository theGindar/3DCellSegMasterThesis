...
# hyperparameters
# ----------
save_path = 'output/model_HMS_edge_gated_14.pkl'
need_resume = True
load_path = 'output/model_HMS_edge_gated_14.pkl'
loss_save_path = 'output/loss_HMS_edge_gated_14.csv'
learning_rate = 1e-4
max_epoch = 500
model_save_freq = 20
...
for ith_epoch in range(0, max_epoch):
    for ith_batch, batch in enumerate(dataset_loader):
        ...
        loss_2 = dice_loss_II_weights(e_output, seg_edge_foreground_groundtruth, weights_foreground_edge) # + \
                  # .5 * balanced_cross_entropy(e_output, seg_edge_foreground_groundtruth)
