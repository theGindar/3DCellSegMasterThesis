...
graphs = load_obj("../../../mnt/graphs_dataset_train_ovules_retrained_total_small_edge_gated")
...
model_save_path = "output/graph_model_focal_ovules_retrained_edge_gated.pt"
