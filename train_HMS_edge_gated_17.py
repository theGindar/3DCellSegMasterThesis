...
from func.loss_func import dice_accuracy, dice_loss_II, dice_loss_II_weights, dice_loss_org_weights, \
    WeightedCrossEntropyLoss, dice_loss_org_individually_with_cellsegloss_and_weights, dice_loss_org_individually_with_cellsegloss_and_weights,\
...
# hyperparameters
# ----------
save_path = 'output/model_HMS_edge_gated_17.pkl'
need_resume = True
load_path = 'output/model_HMS_edge_gated_17.pkl'
loss_save_path = 'output/loss_HMS_edge_gated_17.csv'
learning_rate = 1e-4
max_epoch = 500
model_save_freq = 20
...
for ith_epoch in range(0, max_epoch):
    for ith_batch, batch in enumerate(dataset_loader):
        ...
        loss_2_dice = dice_loss_org_individually_with_cellsegloss_and_weights(e_output, seg_edge_foreground_groundtruth, weights_foreground_edge)
        loss_2_bce = balanced_cross_entropy(e_output, seg_edge_foreground_groundtruth)
        loss_2 = loss_2_dice + .5 * loss_2_bce
