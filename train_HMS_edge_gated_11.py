...
from func.network import VoxResNet, CellSegNet_basic_lite, CellSegNet_basic_edge_gated_IX
...
# hyperparameters
# ----------
save_path = 'output/model_HMS_edge_gated_11.pkl'
need_resume = True
load_path = 'output/model_HMS_edge_gated_11.pkl'
loss_save_path = 'output/loss_HMS_edge_gated_11.csv'
learning_rate = 1e-4
max_epoch = 500
model_save_freq = 20
...
for ith_epoch in range(0, max_epoch):
    for ith_batch, batch in enumerate(dataset_loader):
        ...
        # TODO change!
        loss_2 = dice_loss_org_individually_with_weights(e_output_bb, seg_edge_groundtruth_bb, weights_bb) + \
                 dice_loss_org_individually_with_cellsegloss_and_weights(e_output_f, seg_edge_groundtruth_f, weights_f) + \
