...
from func.network import VoxResNet, CellSegNet_basic_lite, CellSegNet_basic_edge_gated_VIII
...
# hyperparameters
# ----------
save_path = 'output/model_HMS_10.pkl'
need_resume = True
load_path = 'output/model_HMS_10.pkl'
loss_save_path = 'output/loss_HMS_10.csv'
learning_rate = 1e-4
max_epoch = 500
model_save_freq = 20
...
# init model
model=CellSegNet_basic_edge_gated_VIII(input_channel=1, n_classes=3, output_func = "softmax")
