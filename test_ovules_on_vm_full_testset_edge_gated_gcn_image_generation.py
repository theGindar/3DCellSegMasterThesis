...
model_name = "model_Ovules_edge_gated"
results_output_path = "output/results_test_model_Ovules_edge_gated_gcn_image_generation.csv"
...
checkpoint_graph = 'output/graph_model_focal_ovules_retrained_edge_gated.pt'
...
def pipeline(raw_img, hand_seg, model, device,
    ...
    seg_final = segment_super_vox_3_channel_graph_learning_edge_gated_model(raw_img, model, graph_model, device,
                                             ...
                                             intermediate_results_save_path="../../../mnt2/ovules_results/edge_gated/")
