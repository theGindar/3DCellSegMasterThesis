...
# hyperparameters
# ----------
save_path = 'output/model_HMS_edge_gated_with_bce_loss.pkl'
need_resume = False
load_path = 'output/model_HMS_edge_gated_with_bce_loss.pkl'
loss_save_path = 'output/loss_HMS_edge_gated_with_bce_loss.csv'
learning_rate = 1e-4
max_epoch = 500
model_save_freq = 20
...
for ith_epoch in range(0, max_epoch):
    for ith_batch, batch in enumerate(dataset_loader):
        ...
        loss_1=dice_loss_org_weights(seg_output_bb, seg_groundtruth_bb, weights_bb)+\
            ...
            balanced_cross_entropy(seg_output_f, seg_groundtruth_f)+ \
            balanced_cross_entropy(seg_output_bb, seg_groundtruth_bb)
