...
from func.network import VoxResNet, CellSegNet_basic_lite, CellSegNet_basic_lite_w_groupnorm_deep_supervised_XI
...
load_path='output/model_HMS_w_groupnorm_batchsize5_deep_supervision_11.pkl'
