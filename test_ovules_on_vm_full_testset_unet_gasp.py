...
from func.run_pipeline_super_vox import segment_super_vox_3_channel_gasp, semantic_segment_crop_and_cat_3_channel_output, \
...
model_name = "model_Ovules_unet"
results_output_path = "output/results_test_model_Ovules_unet_gasp.csv"
...
def pipeline(raw_img, hand_seg, model, device,
             ...
             transposes=[[0, 1, 2]], reverse_transposes=[[0, 1, 2]], test_file_name=None):
    seg_final = segment_super_vox_3_channel_gasp(raw_img, model, device,
                                             ...
                                             intermediate_results_save_path="../../../mnt2/ovules_results/gasp/")
