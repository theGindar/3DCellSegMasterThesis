...
from func.network import VoxResNet, CellSegNet_basic_lite_w_groupnorm_deep_supervised_V
...
# init model
model=CellSegNet_basic_lite_w_groupnorm_deep_supervised_V(input_channel=1, n_classes=3, output_func = "softmax")
