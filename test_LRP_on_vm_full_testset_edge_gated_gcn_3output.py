...
# graph import stuff
from func.graph_learning import SuperVoxToNxGraph, VoxelGraphDataset, Cluster_Super_Vox_Graph, segment_super_vox_3_channel_graph_learning_edge_gated_model_3output_LRP
...
model_name = "model_LRP_edge_3output"
results_output_path = "output/results_test_model_LRP_edge_gated_limit_background_2_gcn_3output.csv"
load_path = 'output/model_LRP_edge_gated_3output.pkl'
...
checkpoint_graph = 'output/graph_model_focal_LRP_edge_gated_3output.pt'
...
LRP_data_dict_test = LRP_data_dict["test"]
...
def pipeline(raw_img, hand_seg, model, device,
    ...
    seg_final = segment_super_vox_3_channel_graph_learning_edge_gated_model_3output_LRP(raw_img, model, graph_model, device,
