...
torch.manual_seed(script_num*11)
import random
random.seed(script_num*11)
np.random.seed(script_num*11)

image_names_to_segment = [
    "N_512_ds2x.npz"
]
save_path_graph_set = f'graphs_dataset_train_with_augmentations_ovules_retrained_skript_{script_num}_2_edge_gated.pkl'
txt_write_file_path = f'flag_folder/AAA_{script_num}_2_FINISHED_edge_gated.txt'
