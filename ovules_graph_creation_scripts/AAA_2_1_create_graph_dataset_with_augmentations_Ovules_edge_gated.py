...
save_path_graph_set = f'graphs_dataset_train_with_augmentations_ovules_retrained_skript_{script_num}_1_edge_gated.pkl'
txt_write_file_path = f'flag_folder/AAA_{script_num}_1_FINISHED_edge_gated.txt'
