...
from func.run_pipeline_super_vox import segment_super_vox_3_channel_edge_gated_model, semantic_segment_crop_and_cat_3_channel_output_edge_gated_model, \
...
save_path_graph_set = f'graphs_dataset_train_with_augmentations_ovules_retrained_skript_{script_num}_edge_gated.pkl'
txt_write_file_path = f'flag_folder/AAA_{script_num}_FINISHED_edge_gated.txt'
